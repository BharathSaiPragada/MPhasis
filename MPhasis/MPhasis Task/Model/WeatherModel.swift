...
class Weather: Codable {
    ...
    init(coord: Coord, weather: [WeatherElement], base: String, main: Main, visibility: Int, wind: Wind, clouds: Clouds, dt: Int, sys: Sys, timezone: Int, id: Int, name: String, cod: Int) {
        self.coord = coord
